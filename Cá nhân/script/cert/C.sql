...
IF OBJECTPROPERTY(OBJECT_ID('dbo.SP_INS_SINHVIEN'), N'IsProcedure') = 1 
...
IF OBJECTPROPERTY(OBJECT_ID('dbo.SP_INS_NHANVIEN'), N'IsProcedure') = 1 
    DROP PROCEDURE [dbo].[SP_INS_NHANVIEN]
GO
...
IF OBJECTPROPERTY(OBJECT_ID('dbo.SP_SEL_NHANVIEN'), N'IsProcedure') = 1 
